...
class FBOrganizationInsertion(TestCase):
    ...
    def test_fb_org_insertion(self):
        ...
        data is as expected)
        '''
        page_info = self._load_test_json('fb_page_pgh_marathon.json') # pgh marathon page
    ...
    def test_fb_existing_org_insertion(self):
        ...
        '''
        page_info = self._load_test_json('fb_page_mr_smalls.json') 
