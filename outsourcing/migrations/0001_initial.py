...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExternalPlaceSource'
        db.create_table('outsourcing_externalplacesource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.CharField')(max_length=8)),
        ...
        db.send_create_signal('outsourcing', ['ExternalPlaceSource'])

        # Adding unique constraint on 'ExternalPlaceSource', fields ['service', 'uid']
        db.create_unique('outsourcing_externalplacesource', ['service', 'uid'])

        # Adding model 'FacebookPage'
        db.create_table('outsourcing_facebookpage', (
            ('fb_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True)),
            ('ignore', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('outsourcing', ['FacebookPage'])

        # Adding model 'FacebookEventRecord'
        db.create_table('outsourcing_facebookeventrecord', (
            ('fb_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True)),
        ...
        db.send_create_signal('outsourcing', ['FacebookEventRecord'])

        # Adding model 'FacebookOrgRecord'
        db.create_table('outsourcing_facebookorgrecord', (
            ('fb_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True)),
            ('time_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_checked', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='outsourcing_facebookorgrecord_related', to=orm['identity.Organization'])),
            ('ignore', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('outsourcing', ['FacebookOrgRecord'])

        # Adding model 'ICalendarFeed'
        db.create_table('outsourcing_icalendarfeed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('event_role_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('outsourcing', ['ICalendarFeed'])

        # Adding model 'VEventRecord'
        db.create_table('outsourcing_veventrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['outsourcing.ICalendarFeed'])),
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('dtmodified', self.gf('django.db.models.fields.DateTimeField')()),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
        ))
        db.send_create_signal('outsourcing', ['VEventRecord'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ExternalPlaceSource', fields ['service', 'uid']
        db.delete_unique('outsourcing_externalplacesource', ['service', 'uid'])

        # Deleting model 'ExternalPlaceSource'
        db.delete_table('outsourcing_externalplacesource')

        # Deleting model 'FacebookPage'
        db.delete_table('outsourcing_facebookpage')

        # Deleting model 'FacebookEventRecord'
        db.delete_table('outsourcing_facebookeventrecord')

        # Deleting model 'FacebookOrgRecord'
        db.delete_table('outsourcing_facebookorgrecord')

        # Deleting model 'ICalendarFeed'
        db.delete_table('outsourcing_icalendarfeed')

        # Deleting model 'VEventRecord'
        db.delete_table('outsourcing_veventrecord')
